...
import { ArrowRight, Sparkles, Smartphone, Monitor, Code2 } from "lucide-react"
import { Button } from "@/components/ui/button"

const techBadges = [
  { name: "Next.js", color: "from-white/10 to-white/5" },
  { name: "React", color: "from-blue-500/20 to-blue-600/10" },
  { name: "React Native", color: "from-indigo-500/20 to-purple-600/10" },
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            <span className="text-foreground">Sites, sistemas e apps</span>
            <br />
            <span className="gradient-text">que fazem seu negócio</span>
            <br />
            <span className="text-foreground">crescer de verdade.</span>
          </motion.h1>
          ...
          >
            Soluções digitais profissionais com tecnologia de ponta — landing pages que convertem, 
            sistemas que organizam e aplicativos mobile que encantam. 
            Tudo feito sob medida para sua empresa decolar online.
          </motion.p>
          ...
          >
            ...
            >
              <a href="#projects">Ver Projetos Recentes</a>
            </Button>
          </motion.div>
